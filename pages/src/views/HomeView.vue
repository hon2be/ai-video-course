...
<script setup>
const lessons = [
  { to:'/lesson/01', num:'01', title:'영상 기획과 스토리보드', desc:'AI 영상 제작의 기획 단계와 스토리보드 작성법', tag:'교재', color:'#C2410C' },
  { to:'/lesson/02', num:'02', title:'미드저니 완전 정복', desc:'텍스트로 이미지 생성하는 미드저니 활용법', tag:'교재', color:'#C2410C' },
  { to:'/lesson/03', num:'03', title:'Adobe Firefly', desc:'파이어플라이로 비디오 생성하기', tag:'교재', color:'#C2410C' },
  { to:'/lesson/04', num:'04', title:'CapCut AI 영상 편집', desc:'캡컷으로 AI 영상 완성하기', tag:'교재', color:'#C2410C' },
  { to:'/lesson/05', num:'05', title:'Firefly 동일인물 만들기', desc:'GPT → Firefly 데이터셋 → Reference Image 완전 가이드', tag:'강의 스크립트', color:'#4a1fb8' },
  { to:'/lesson/05/prompts', num:'05+', title:'인물 데이터셋 프롬프트 모음', desc:'카메라각도·표정·포즈·의상 전체 프롬프트', tag:'참고자료', color:'#0891b2' },
  { to:'/lesson/06', num:'06', title:'미드저니 동일인물 --cref', desc:'--cref & --cw 파라미터로 일관성 있는 캐릭터 생성', tag:'강의 스크립트', color:'#4a1fb8' },
]
</script>
